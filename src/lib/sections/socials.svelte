...
<section
	...
	use:inertOffscreen
	id="socials"
	class="flex w-full flex-col max-lg:h-svh lg:min-h-svh lg:flex-row lg:gap-12"
>
	<!-- mobile heading -->
	<div
	...
	<div
		class="flex w-full px-3 max-lg:flex-1 max-lg:min-h-0 max-lg:items-stretch max-lg:justify-start max-lg:py-6 lg:sticky lg:top-0 lg:order-1 lg:h-svh lg:w-3/5 lg:items-center lg:justify-center lg:px-12"
	>
