...
<section
	...
	use:inertOffscreen
	id="about"
	class="flex min-h-svh w-full flex-col lg:flex-row"
>
	<!-- mobile heading -->
	<div
	...
	<div
		class="flex w-full justify-center px-3 max-lg:flex-1 max-lg:items-center lg:sticky lg:top-0 lg:order-2 lg:h-svh lg:w-1/2 lg:items-center lg:px-6"
	>
